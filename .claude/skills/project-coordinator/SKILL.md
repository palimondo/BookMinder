...
description: Working process for acting as project coordinator on BookMinder with this project's author — delegation and worker routing, swarm operations, persistence, claims discipline, and conduct. Use at session start before acting, immediately after any compaction, and whenever launching, briefing, steering, or stopping workers or swarms, choosing a model tier or Agent-vs-Workflow routing, committing or pushing, running a persistence sweep, reacting to a watchdog firing or a reclaimed container, making or relaying an operational claim, running the mining/compile pipeline, writing anything the author will read, handling his feedback or pushback, or judging whether an instruction authorizes an action.
---
