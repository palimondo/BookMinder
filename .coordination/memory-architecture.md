...
This file is the reasoning record; it exists so the split is not re-litigated when the discussion is forgotten. Reopening it means arguing against the reasons below, not rediscovering them.
